...
Here I showcase my skills completely 10 ad hoc requests to help the business have some insights on the data.

### Data Set ###
This database and data sets came from a [Code Basics](https://codebasics.io/challenge/codebasics-resume-project-challenge) challenge. 

### Data Structure ###
Tables:
1. dim_customer: contains customer-related data
- Columns: customer_code, customer, platform, channel, market, region, sub_zone
3. dim_product: contains product-related data
4. fact_gross_price: contains gross price information for each product
5. fact_manufacturing_cost: contains the cost incurred in the production of each product
6. fact_pre_invoice_deductions: contains pre-invoice deductions information for each product
7. fact_sales_monthly: contains monthly sales data for each product.
